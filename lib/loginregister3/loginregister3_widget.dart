...
class Loginregister3Widget extends StatefulWidget {
  Loginregister3Widget({Key key}) : super(key: key);

  @override
  _Loginregister3WidgetState createState() => _Loginregister3WidgetState();
}

class _Loginregister3WidgetState extends State<Loginregister3Widget> {
